    ...
    [
      require.resolve('@docusaurus/plugin-client-redirects'),
      {
        redirects: [
          ...
          {from: '/docs/tlpp/rest-doc/exemplos/completo', to: '/docs/tlpp/rest/metadados/exemplos/completo'},
          {from: '/docs/tlpp/rest-doc/exemplos/endpoints-dinamicos', to: '/docs/tlpp/rest/metadados/exemplos/endpoints-dinamicos'},
          {from: '/docs/tlpp/rest-doc/exemplos/basic/description-only', to: '/docs/tlpp/rest/metadados/exemplos/basic/description-only'},
          {from: '/docs/tlpp/rest-doc/exemplos/basic/annotation', to: '/docs/tlpp/rest/metadados/exemplos/basic/annotation'},
          {from: '/docs/tlpp/rest-doc/exemplos/basic/i18n-id', to: '/docs/tlpp/rest/metadados/exemplos/basic/i18n-id'},
          {from: '/docs/tlpp/rest-doc/exemplos/basic/function', to: '/docs/tlpp/rest/metadados/exemplos/basic/function'},
          {from: '/docs/tlpp/rest-doc/exemplos/basic/multiline', to: '/docs/tlpp/rest/metadados/exemplos/basic/multiline'},
          ...
          {from: '/docs/exemplos/completo', to: '/docs/tlpp/rest/metadados/exemplos/completo'},
          {from: '/docs/exemplos/endpoints-dinamicos', to: '/docs/tlpp/rest/metadados/exemplos/endpoints-dinamicos'},
          {from: '/docs/exemplos/basic/description-only', to: '/docs/tlpp/rest/metadados/exemplos/basic/description-only'},
          {from: '/docs/exemplos/basic/annotation', to: '/docs/tlpp/rest/metadados/exemplos/basic/annotation'},
          {from: '/docs/exemplos/basic/i18n-id', to: '/docs/tlpp/rest/metadados/exemplos/basic/i18n-id'},
          {from: '/docs/exemplos/basic/function', to: '/docs/tlpp/rest/metadados/exemplos/basic/function'},
          {from: '/docs/exemplos/basic/multiline', to: '/docs/tlpp/rest/metadados/exemplos/basic/multiline'},
