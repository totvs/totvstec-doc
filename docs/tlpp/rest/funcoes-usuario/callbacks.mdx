...
| Callback | Momento | Onde configurar |
|----------|---------|-----------------|
| [OnBlock](/docs/tlpp/rest/funcoes-usuario/on-block) | Na subida do REST — bloqueia URNs listadas | Thread Pool |
| [OnAllow](/docs/tlpp/rest/funcoes-usuario/on-allow) | Na subida — permite só URNs listadas | Thread Pool |
| [OnSelect](/docs/tlpp/rest/funcoes-usuario/on-select) | Antes de atender — escolhe qual slave processa | Thread Pool |
| [OnStart](/docs/tlpp/rest/funcoes-usuario/on-start) | Thread criada | Slave (ou pool sem slaves) |
| [OnStop](/docs/tlpp/rest/funcoes-usuario/on-stop) | Thread encerrada | Slave (ou pool sem slaves) |
| [OnSend](/docs/tlpp/rest/funcoes-usuario/on-send) | Antes de enviar resposta ao cliente | Slave (ou pool sem slaves) |
| [OnError](/docs/tlpp/rest/funcoes-usuario/on-error) | Exceção na thread | Pool e/ou Slave |
