...
import catalog from '@site/src/data/restdoc-methods.json';
...
export default function RestDocMethodCatalog({groupId}: Props): ReactNode {
  ...
  return (
    <div>
      ...
      <nav className={styles.index} aria-label={`Índice — ${group.title}`}>
        <p className={styles.indexTitle}>Nesta seção</p>
