...
export const EXEMPLO_WS_RESTFUL_START = `#include "tlpp-core.th"
...
// Inicializa serviço HTTP mantendo a compatibilidade WsRestful
// ------------------------------------------------------------
nResult := tlpp.rest.wsRestfulStart( jo, '/myrest' )
 
 
Return nResult`;
export const EXEMPLO_WS_RESTFUL_START_LANG = 'advpl' as const;
